...
class SolveCVRPWindow:
    def __init__(self, root):
        ...
        self.solve_button = ttk.Button(self.top, text="Resolver CVRP", command=self.solve_cvrp)
    ...
    def solve_cvrp(self):
        vehicle_routes = solve_cvrp(self.clients, self.vehicles, self.warehouse)
        show_map(vehicle_routes, self.warehouse, filename='optimized_cvrp_route.html')
